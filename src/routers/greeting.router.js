...
router.post('/greeting', upload.single('image'), GreetingController.createGreeting)
router.get('/greeting', GreetingController.fetchGreeting)
router.patch('/greeting/:id', upload.single('image'), GreetingController.updateThroughPatchReq)
